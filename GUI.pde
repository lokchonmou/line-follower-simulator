...
public void createGUI(){
  ...
  sensor_width.setLimits(8.0, 8.0, 20.0);
  ...
  label1 = new GLabel(window1, 36, 24, 80, 20);
  ...
  max_speed = new GSlider(window1, 360, 48, 144, 60, 10.0);
